  ...
  Future<bool> fetchUserInfos() async {
    ...
    try {
      final http.Response response = await http
          .get("https://foodapp-3411e-default-rtdb.firebaseio.com/users.json");
  ...
  Future<bool> addUserInfo(Map<String, dynamic> userInfo) async {
    ...
    try {
      final http.Response response = await http.post(
          "https://foodapp-3411e-default-rtdb.firebaseio.com/users.json",
    ...
    try {
      ...
      if (authMode == AuthMode.SignUp) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBKFvoBVa1F6vf9b8wxKBCw7iPtUKgq1PU",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      } else if (authMode == AuthMode.SignIn) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBKFvoBVa1F6vf9b8wxKBCw7iPtUKgq1PU",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      }
