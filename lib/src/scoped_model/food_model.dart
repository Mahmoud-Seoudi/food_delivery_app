//    .get("http://192.170.198.108/flutter_food_app/api/foods/getFoods.php")
//
import 'dart:convert';
...
class FoodModel extends Model {
  ...
  Future<bool> addFood(Food food) async {
    ...
    try {
      ...
      final http.Response response = await http.post(
          "https://foodapp-3411e-default-rtdb.firebaseio.com/foods.json",
  ...
  Future<bool> fetchFoods() async {
    ...
    try {
      final http.Response response = await http
          .get("https://foodapp-3411e-default-rtdb.firebaseio.com/foods.json");
  ...
  Future<bool> updateFood(Map<String, dynamic> foodData, String foodId) async {
    ...
    try {
      await http.put(
          "https://foodapp-3411e-default-rtdb.firebaseio.com/foods/${foodId}.json",
          body: json.encode(foodData));
